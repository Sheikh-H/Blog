...
tags: [python, programming, course, 30days, day21]
pin: false
math: false
mermaid: false
image:
...
**Objects** is a term given to an instance of a class being used. They allow for parameters inside the class to store values or even perform functions. Think of assigning a normal variable to a function, here you would assign a normal vairable to a class which then becomes an **Object**.
