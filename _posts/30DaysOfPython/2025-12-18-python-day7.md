...
description: >-
  In Day 7 of the 30 Days of Python I go on to learn about sets. Sets can be described as storing unordered, unindexed, and unqiue values only. These are the functions we can perform with them.
author: Sheikh Hussain
date: 2025-12-25 17:00:00 +0000
...
This is also the topic that introduces some new functions that I haven't come across before, which I found very similar to using a MySQL database / CLI. Functions like Union, Intersection, Difference, Symmteric Difference, Subset, Super Set, and Disjoint set.
...
Looking back over, though I still don't know where I would use these functions and what it would be useful for, I would now say I do uunderstand them and it's just a matter of finding where I would put them.
