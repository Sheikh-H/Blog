...
I then turned to ChatGPT to help me learn how to use the matplotlib module in Python to graph data in the database. This would technically be the _dashboard_ of the website statistics.
