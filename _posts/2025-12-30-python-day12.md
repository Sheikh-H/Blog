...
tags: [python, programming, course, 30days, day12, modules]
pin: false
math: false
mermaid: false
image:
...
<!--prettier-ignore-->
> 💡**Hint**: A *function* inside of *a module* is known as an **attribute** (module -> attribute e.g `math.pi` is module.attribute).
{: .prompt-tip}
