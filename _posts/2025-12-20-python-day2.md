...
1. create a variable and store information in there 
2. use that variable.
...
> There is a topic called **List Comprehension** that uses a list data type to make an array/list of information *built* from a function. I'll be learning about this on **Day 13**.
{: .prompt-tip}
...
![Python built-in functions overview](/assets/img/posts/01/2026/builtin-functions.png)
